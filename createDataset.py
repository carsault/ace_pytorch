...
ACEdataImport.datasetSaved(files_train, "train", sizeOfPartTrain, dictFilenameTrain, args, dictChord, listChord, randTransp, padding = True)
print("Process valid dataset")
ACEdataImport.datasetSaved(files_valid, "valid", sizeOfPartValid, dictFilenameValid, args, dictChord, listChord, padding = True)
print("Process test dataset")
ACEdataImport.datasetSaved(files_test, "test", sizeOfPartTest, dictFilenameTest, args, dictChord, listChord, padding = True)